...
@Entity
@Table(name = "core_academic_program_yearly_fee")
@Data
@AllArgsConstructor
@NoArgsConstructor
public class CoreAcademicProgramYearlyFee {

    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Column(name = "academic_program_yearly_fee_id")
    ...
    @Column(name = "fee_amount", precision = 9, scale = 2)
