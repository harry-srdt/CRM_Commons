...
@Entity
@Table(name = "core_scholarship_slab")
@Data
@AllArgsConstructor
@NoArgsConstructor
public class CoreScholarshipSlab {
    ...
    @JoinColumn(name = "scholarshipSchemeId", nullable = false)
    private CoreScholarshipScheme scholarshipScheme;
